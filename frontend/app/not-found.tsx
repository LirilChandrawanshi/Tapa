...
const LIKELY_LINKS = [
  ...
  { label: "All Ritual Guides", href: "/ritual-guides" },
  { label: "2026 Vrat Calendar", href: "/panchang/vrat-calendar" },
  { label: "Beginner's Guides", href: "/ritual-guides/beginners-guides" },
  { label: "The Glossary", href: "/glossary" },
] as const;

export default function NotFound() {
  return (
    <section className="hero-404 relative flex min-h-[640px] items-center overflow-hidden">
      <div
        aria-hidden
      ...
      <div className="relative z-[2] mx-auto grid w-full max-w-[1280px] items-center gap-7 px-4 py-9 md:grid-cols-[1.2fr_0.8fr] md:gap-12 md:px-10 md:py-14">
        <div>
          <div className="mb-5 inline-flex items-baseline gap-3 rounded-[14px] border border-white/20 bg-white/[0.08] px-5 pt-[11px] pb-3">
            ...
            <span className="text-[11px] leading-normal font-bold tracking-[1px] text-hero-text/70">
              ERROR
              <b className="block text-[12.5px] text-white">Page not found</b>
            </span>
          </div>
          <h1 className="mb-4 text-[29px] leading-[1.1] font-bold tracking-[-1px] text-hero-text md:text-[42px]">
            Hanuman searched all of Lanka.
            <br />
            <em className="text-yellow not-italic">
              You have searched one page.
            </em>
          </h1>
          <p className="mb-[14px] max-w-[520px] text-[15px] leading-[1.8] text-hero-text/70 md:text-[17px]">
            Whatever was here has moved, or was never here. Neither is a
            problem — the guide you want is almost certainly a search away.
          </p>
          <p className="mb-[26px] max-w-[480px] border-l-2 border-[rgba(227,181,103,0.35)] pl-4 text-[13px] leading-[1.75] text-hero-text/45 italic">
            He did not find her in the first garden either. The Sundarkand is
            five hundred verses of looking, and it ends well.
          </p>
        ...
        <div className="rounded-2xl border border-white/[0.15] bg-white/[0.07] px-[22px] py-5">
          ...
          <p className="mt-3 border-t border-white/[0.09] pt-3 text-xs leading-[1.7] text-hero-text/50">
            If you followed a link from somewhere and it brought you here, tell
            us — we would rather fix it than leave it.
          </p>
        </div>
      </div>
    </section>
